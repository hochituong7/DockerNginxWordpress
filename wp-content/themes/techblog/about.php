            ...
            <div class="row mb-5">
                ...
                <div class="d-md-flex post-entry-2 half">
                    <a href="#" class="me-4 thumbnail">
                        <img src="<?php echo bloginfo('template_directory');?>/assets/img/post-landscape-2.jpg" alt="" class="img-fluid">
                    </a>
                ...
                <div class="d-md-flex post-entry-2 half mt-5">
                    <a href="#" class="me-4 thumbnail order-2">
                        <img src="<?php echo bloginfo('template_directory');?>/assets/img/post-landscape-1.jpg" alt="" class="img-fluid">
                    </a>
        ...
        <div class="container" data-aos="fade-up">
            <div class="row justify-content-between align-items-lg-center">
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-6">
                            <img src="<?php echo bloginfo('template_directory');?>/assets/img/post-portrait-3.jpg" alt="" class="img-fluid mb-4">
                        </div>
                        <div class="col-6 mt-4">
                            <img src="<?php echo bloginfo('template_directory');?>/assets/img/post-portrait-4.jpg" alt="" class="img-fluid mb-4">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container" data-aos="fade-up">
            <div class="row">
                ...
                <div class="col-lg-4 text-center mb-5">
                    <img src="<?php echo bloginfo('template_directory');?>/assets/img/person-1.jpg" alt="" class="img-fluid rounded-circle w-50 mb-4">
                ...
                <div class="col-lg-4 text-center mb-5">
                    <img src="<?php echo bloginfo('template_directory');?>/assets/img/person-2.jpg" alt="" class="img-fluid rounded-circle w-50 mb-4">
                    <h4>Wade Warren</h4>
                ...
                <div class="col-lg-4 text-center mb-5">
                    <img src="<?php echo bloginfo('template_directory');?>/assets/img/person-3.jpg" alt="" class="img-fluid rounded-circle w-50 mb-4">
                    <h4>Jane Cooper</h4>
                ...
                <div class="col-lg-4 text-center mb-5">
                    <img src="<?php echo bloginfo('template_directory');?>/assets/img/person-4.jpg" alt="" class="img-fluid rounded-circle w-50 mb-4">
                    <h4>Cameron Williamson</h4>
                    <span class="d-block mb-3 text-uppercase">Editor Staff</span>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, perspiciatis repellat maxime,
                        adipisci non ipsam at itaque rerum vitae, necessitatibus nulla animi expedita cumque provident
                ...
                <div class="col-lg-4 text-center mb-5">
                    <img src="<?php echo bloginfo('template_directory');?>/assets/img/person-5.jpg" alt="" class="img-fluid rounded-circle w-50 mb-4">
                    <h4>Cameron Williamson</h4>
                    <span class="d-block mb-3 text-uppercase">Editor Staff</span>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, perspiciatis repellat maxime,
                        adipisci non ipsam at itaque rerum vitae, necessitatibus nulla animi expedita cumque provident
                ...
                <div class="col-lg-4 text-center mb-5">
                    <img src="<?php echo bloginfo('template_directory');?>/assets/img/person-6.jpg" alt="" class="img-fluid rounded-circle w-50 mb-4">
                    <h4>Cameron Williamson</h4>
                    <span class="d-block mb-3 text-uppercase">Editor Staff</span>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, perspiciatis repellat maxime,
                        adipisci non ipsam at itaque rerum vitae, necessitatibus nulla animi expedita cumque provident
